...
@RequestMapping("/api")
@AllArgsConstructor
public class MaestroHisEtniaController {

    private final MaestroHisEtniaRepository repository;
    private final CsvUploadService csvUploadService;
    private final JdbcTemplate jdbcTemplate;
    private final String name_table = "maestro_his_etnia";
    ...
    public ResponseEntity<Page<MaestroHisEtnia>> getAll(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "10") int size) {
        Pageable pageable = PageRequest.of(page, size);
        Page<MaestroHisEtnia> ubigeosPage = repository.findAll(pageable);
