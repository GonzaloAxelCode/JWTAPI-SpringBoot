...
public class MaestroCondicionContratoController {
    ...
    private final MaestroCondicionContratoRepository repository;
    private final CsvUploadService csvUploadService;
    private final JdbcTemplate jdbcTemplate;
    private final String name_table = "maestro_condicion_contrato";
    ...
    public ResponseEntity<Page<MaestroCondicionContrato>> getAll(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "10") int size) {
        Pageable pageable = PageRequest.of(page, size);
        Page<MaestroCondicionContrato> ubigeosPage = repository.findAll(pageable);
