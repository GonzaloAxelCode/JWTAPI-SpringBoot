...
@RequestMapping("/api")
@AllArgsConstructor
public class MaestroHisFinanciadorController {
    private final MaestroHisFinanciadorRepository repository;
    private final CsvUploadService csvUploadService;
    private final JdbcTemplate jdbcTemplate;
    private final String name_table = "maestro_his_financiador";
    ...
    public ResponseEntity<Page<MaestroHisFinanciador>> getAll(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "10") int size) {
        Pageable pageable = PageRequest.of(page, size);
        Page<MaestroHisFinanciador> ubigeosPage = repository.findAll(pageable);
