...
import com.JWT.JsonWebToken.Upload.Registrador.MaestroHisRegistradorRepository;
...
@RequestMapping("/api")
@AllArgsConstructor
public class MaestroHisProfesionController {

    private final MaestroHisProfesionRepository repository;
    private final CsvUploadService csvUploadService;
    private final JdbcTemplate jdbcTemplate;
    private final String name_table = "maestro_his_profesion";
    ...
    public ResponseEntity<Page<MaestroHisProfesion>> getAll(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "10") int size) {
        Pageable pageable = PageRequest.of(page, size);
        Page<MaestroHisProfesion> ubigeosPage = repository.findAll(pageable);
