...
import com.JWT.JsonWebToken.Upload.CondicionContrato.MaestroCondicionContratoRepository;
...
@RequestMapping("/api")
@AllArgsConstructor
public class MaestroHisColegioController {


    private final MaestroHisColegioRepository repository;
    private final CsvUploadService csvUploadService;
    private final JdbcTemplate jdbcTemplate;
    private final String name_table = "maestro_his_colegio";
    ...
    public ResponseEntity<Page<MaestroHisColegio>> getAll(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "10") int size) {
        Pageable pageable = PageRequest.of(page, size);
        Page<MaestroHisColegio> ubigeosPage = repository.findAll(pageable);
    ...
    public ResponseEntity<Object> deleteTable() {
        try {
            ...
            String sql = "TRUNCATE TABLE " + name_table + " ,cita_nominal,maestro_his_profesion,maestro_his_personal";
