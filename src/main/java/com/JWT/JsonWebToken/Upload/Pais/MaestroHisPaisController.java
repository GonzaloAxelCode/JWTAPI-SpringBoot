...
@RequestMapping("/api")
@AllArgsConstructor
public class MaestroHisPaisController {

    private final MaestroHisPaisRepository repository;
    private final CsvUploadService csvUploadService;
    private final JdbcTemplate jdbcTemplate;
    private final String name_table = "maestro_his_pais";
    ...
    public ResponseEntity<Page<MaestroHisPais>> getAll(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "10") int size) {
        Pageable pageable = PageRequest.of(page, size);
        Page<MaestroHisPais> ubigeosPage = repository.findAll(pageable);
