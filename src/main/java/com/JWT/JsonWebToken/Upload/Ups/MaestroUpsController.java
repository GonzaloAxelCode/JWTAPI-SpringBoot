...
@RequestMapping("/api")
@AllArgsConstructor
public class MaestroUpsController {
    private final MaestroUpsRepository repository;
    private final CsvUploadService csvUploadService;
    private final JdbcTemplate jdbcTemplate;
    private final String name_table = "maestro_ups";
    ...
    public ResponseEntity<Object> importCSV(@RequestParam("csv_file") MultipartFile file, @RequestParam String delimiter, @RequestParam String encoding) {
        ...
        try {
            ...
            config.setColumnTypes(new String[]{"string", "string"});
    ...
    public ResponseEntity<Page<MaestroUps>> getAll(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "10") int size) {
        Pageable pageable = PageRequest.of(page, size);
        Page<MaestroUps> ubigeosPage = repository.findAll(pageable);
